      ...
      <div className="footer-container">
            ...
            <form className="newsletter-form" onSubmit={handleSubscribe}>
              <div className="input-group">
                <input
                  ...
                  required
                />
                <button type="submit" className={`subscribe-btn ${isSubscribed ? "success" : ""}`}>
                  {isSubscribed ? (
        ...
        <div className="footer-main">
          ...
          <div className="footer-section">
            ...
            <ul className="footer-links">
              <li>
                <a href="/catering">Event Catering</a>
              </li>
              <li>
                <a href="/corporate">Corporate Meals</a>
              </li>
              <li>
                <a href="/wedding">Wedding Catering</a>
              </li>
              <li>
                <a href="/private">Private Chef</a>
              </li>
              <li>
                <a href="/consultation">Menu Consultation</a>
              </li>
            </ul>
          </div>
